...
from .forms import validate_date
...
class Song(models.Model):
    ...
    UploadTime  =models.DateTimeField(null=False,blank=False,default=datetime.now(),validators=[validate_date],)#null are for database

class Podcast(models.Model):
    ID          =models.PositiveBigIntegerField(primary_key=True,null=False,blank=False,)
    Name        =models.CharField(max_length=100,null=False,blank=False,)
    Duration    =models.PositiveIntegerField(null=False,blank=False,)#starts from 0
    UploadTime  =models.DateTimeField(null=False,blank=False,default=datetime.now(),validators=[validate_date],)
...
class Audiobook(models.Model):
    ...
    Duration    =models.PositiveIntegerField(null=False,blank=False,validators=[validate_date])
    UploadTime  =models.DateTimeField(null=False,blank=False,default=datetime.now(),validators=[validate_date],)